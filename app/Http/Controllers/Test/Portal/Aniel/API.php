...
namespace App\Http\Controllers\Test\Portal\Aniel;
...
class API
{
    ...
    private function storeOrder()
    {
        ...
        $form = [
            ...
            "tipoServico" => 'Plano Internet Ativação',
            "subTipoServico" => 'Plano Internet Ativação',
            "plano" => "",
            ...
            "numOS" => '99999999',
            "uni" => "",
            "dataHoraAgendamento" => '2024-06-19 08:00:00',
            "tipoImovel" => "INDIFERENTE",
            "grupoArea" => 'DISTRITO FEDERAL',
            "area" => 'Sobradinho',
            "localidade" => 'Setor de Habitações Individuais Sul',
            "endereco" => 'SHIS QL 2 Conjunto 5 TESTE DE DESENVOLVIMENTO',
            "numeroEndereco" => '32Teste',
            "cep" => '71610-055',
            "complemento" => 'Sem complemento, pois é um teste',
            "bairro" => 'Setor de Habitações Individuais Sul',
            "cidade" => 'Brasília',
            "pontoReferencia" => "",
            "uf" => "DF",
            "observacao" => 'Sem observações, pois é um teste',
            "facilidade" => "",
            "latitude" => $lat,
            "longitude" => $lng,
            "tecnico" => "",
            "nomeCliente" => 'Time de Desenvolvimento',
            "telefoneCelularCliente" => '(61) 99999-9999',
            "telefoneFixoCliente" => '(61) 99999-9999',
            "emailCliente" => 'teste@agetelecom.com.br',
            "loginRadius" => "",
            "senhaRadius" => "",
            "contratoCliente" => '246970102',
            "categoriaCliente" => "",
            "numDoc" => '1047024',
            "settings" => [
                "user" => 'AGE',
    ...
    assignments.description as \"observation\",
      ...
      order by assignment_incidents.protocol, s.start_date desc limit 1";
...
//            SELECT
//                *
//                FROM TB_DOCUMENTO_PRODUCAO tse
//            rows 1
//        SQL;
