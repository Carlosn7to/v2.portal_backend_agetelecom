                ...
                <tr>
                    <td style="padding: 0 0 0 0; text-align: center; width: 100%; ">
                        <img style="height: 400px"
                             src="https://agenotifica.s3.sa-east-1.amazonaws.com/age/ReguaDeCobranca/regua_de_cobranca_age_fibra/Grupo+88+1.png"
                             alt="">
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="550">
                            <tr>
                                <td
                                    ...
                                    <p style="font-size: 30px;"><strong style="color: #F41B11">CANCELAMENTO DE SINAL</strong></p>
                                    <p>Olá {{$client['name']}},</p>
                                    <p><b style="color: #F41B11;">Sua fatura está em aberto há {{abs($client['days_until_expiration'])}} dias. </b>
                                        Infelizmente, devido a este atraso no pagamento, o sinal de
                                        internet do seu plano está temporariamente suspenso e seu contrato poderá ser
                                        <b style="color: #F41B11">cancelado</b>.
                                    </p>
                                    <p>
                                        Efetue o pagamento o mais breve possível para assegurar que você siga curtindo a sua conexão. Ficar sem internet ninguém merece, né?
                                    </p>
                ...
                <tr>
                    <td align="center">
                        <table width="400">
                            <tr>
                                <td>
                                    <p style="font-size: 10px; text-align: center; color: #ec681c;">P.S: Este e-mail
                                        pode ser desconsiderado se você já tiver pagado sua fatura.
                                    </p>
                                </td>
                            </tr>
                            <tr>
