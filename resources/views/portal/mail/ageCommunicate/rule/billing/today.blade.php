                ...
                <tr>
                    <td style="padding: 0 0 0 0; text-align: center; width: 100%; ">
                        <img style="height: 400px"
                             src="https://agenotifica.s3.sa-east-1.amazonaws.com/age/ReguaDeCobranca/regua_de_cobranca_age_fibra/Grupo+84+2.png"
                             alt="">
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="550">
                            <tr>
                                <td
                                    ...
                                    <p>Olá {{$client['name']}},</p>
                                    <p>Passando para lembrar que a <b style="color: #F41B11;">sua fatura AGE Telecom
                                            vence HOJE! </b>Para
                                        assegurar a continuidade da sua conexão e evitar qualquer interrupção nos
                                        serviços, solicitamos a gentileza de efetuar o pagamento até a data de
                                        vencimento.
